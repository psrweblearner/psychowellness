...
<!--Tab Menu Start Here-->
 ...
 <?php 
 $query = "select * from service2 where id=1";
$run = mysqli_query($con,$query);
while($row= mysqli_fetch_array($run)){
...
<div class="container">
   <div class="row">
           <?php 
 $query = "select * from service1 where id=1";
$run = mysqli_query($con,$query);
while($row= mysqli_fetch_array($run)){
...
<div class="col-md-8" style="text-align:center;">	 	        <?php 
 $query = "select * from service1 where id=1";
$run = mysqli_query($con,$query);
while($row= mysqli_fetch_array($run)){
...
?>
<div class="quoate" style="margin-top: 52px;">
<p style="text-align:center;"><?php echo $quots;?></p>
