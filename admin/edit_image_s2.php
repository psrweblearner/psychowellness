...
<form method="post" action="edit_image_s2.php?edit_image=<?php echo $edit_id1; ?>" enctype="multipart/form-data">
...
if(isset($_POST['update'])){
	...
	$temp_images1= $_FILES['image3']['tmp_name'];
		...
		$update_query ="update service1 set image3='$image' where id='$update_id'";
