...
<form method="post" action="edit_image_t1.php?edit_image=<?php echo $edit_id1; ?>" enctype="multipart/form-data">
...
if(isset($_POST['update'])){
	...
	$temp_images1= $_FILES['image1']['tmp_name'];
		...
		$update_query ="update service2 set image1='$image' where id='$update_id'";
