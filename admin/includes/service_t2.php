...
<table  align="center" border="3">
	...
	<tr>
		<td align="center" colspan="13" bgcolor="orange"><h1>Addiction</h1></td>
	</tr>
	<tr>
		<th>S.No</th>
		<th>Image</th>
	...
	if(isset($_GET['service_t2'])){
		...
		$query = "select * from service2 where id=5";
...
?>
	...
	<tr align="center">
		...
		<td><a href="edit_service_t.php?edit=<?php echo $id; ?>">Edit</a></td>
