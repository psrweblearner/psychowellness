...
<table  align="center" border="3">
	...
	<tr>
		<td align="center" colspan="13" bgcolor="orange"><h1>Obsessive-Compulsive Disorder(OCD)</h1></td>
	</tr>
	<tr>
		<th>S.No</th>
		<th>Image</th>
	...
	if(isset($_GET['service_t5'])){
		...
		$query = "select * from service2 where id=4";
...
?>
	...
	<tr align="center">
       ...
       <td><a href="edit_image_t2.php?edit_image_t2=<?php echo $id; ?>"><img src="images/<?php echo $image2; ?>" width="50" height="50"></a></td>
		...
		<td><h4><a href="edit_service_t.php?edit=<?php echo $id; ?>">Click here for Edit</a><h4></td>
