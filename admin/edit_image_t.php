...
<form method="post" action="edit_image_t.php?edit_image=<?php echo $edit_id1; ?>" enctype="multipart/form-data">
...
if(isset($_POST['update'])){
	...
	$temp_images1= $_FILES['image']['tmp_name'];
		...
		$update_query ="update service2 set image='$image' where id='$update_id'";
